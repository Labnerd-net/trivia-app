...
- **`makeLocalProvider`** — lazy-loads a bundled card game JSON from `public/data/`. Used for All Of Us, Mind the Gap, and Trivial Pursuit Millennium. Card data is imported via `scripts/import-cards.js`. See **Card scanning pipeline** below.
